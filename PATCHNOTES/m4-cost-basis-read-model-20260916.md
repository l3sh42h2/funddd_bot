...
- This is read-only. It does not change orders, execution state, balances or database schema. The generic leg DTO can display a proven spot cost basis separately from total PnL.
