...
Статус: deployed — установлен a976bec (13.09 22:37:49 UTC, deploy.sh exit 0, strict; до него 288dea1 21:57),
связка выключена.
...
Установлено a976bec (13.09 22:37:49 UTC): Gate POSITION_NOT_FOUND = флэт; сверка перечитывает позицию до совпадения
с журналом. VPS: 2132 passed, 9 skipped. Первая попытка остановлена нестабильным тестом коллектора
test_schedule_respects_cadences (к правке не относится; 5/5 отдельно) — повтор прошёл.
