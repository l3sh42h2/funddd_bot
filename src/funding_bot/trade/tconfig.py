...
OKX_TRIM_RATE_MAX = 100                 # увиденная вживую доля; больше — предупреждение в журнал (не стоп с 19.09)
# 4663 — тот же получатель и та же доля (100), что у BSC: хвост обоих живых ответов /swap 13.09.
# 19.09 OKX сменил получателя на BSC на 0x7fc8…e58b: в сети — 276 переводов излишка за ~25 мин, все от роутера OKX
# 0x5994…4dec методом dagSwapByOrderId; на старый 0xfa00…2a1b за ~1.7 ч — ни одного. Незнакомый получатель — только
# предупреждение в журнал (evm_swap._check_trim), список — чтобы знакомые не шумели.
OKX_TRIM_RECEIVERS = {"56": frozenset({"0xfa00a9ed787f3793db668bff3e6e6e7db0f92a1b",
                                       "0x7fc8fd8bb3192e2d62a3d8d97d9a7924d4bae58b"}),
