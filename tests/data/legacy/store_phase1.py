# НЕ ТЕСТ: копия trade/store.py выкачанного релиза (фаза 1 + рейтинг, до схемы 2), sha256 оригинала e550c214f3067627b5f8782316f70e02c7438b1baa058140d8890893cf540b16.
# Тесты грузят её как «прежний код» и проверяют, что он работает на БД новой схемы (откат кода). Не править.
